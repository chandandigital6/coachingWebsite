    ...
    <div class="container-fluid py-5" data-aos="fade-up">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-5">
                <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;" data-aos="zoom-in">Teachers</h5>
                <h1 data-aos="fade-up">Meet Our Teachers</h1>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-3 text-center team mb-4" data-aos="fade-right">
                ...
                <div class="col-md-6 col-lg-3 text-center team mb-4" data-aos="fade-left">
                    <div class="team-item rounded overflow-hidden mb-2">
                        <div class="team-img position-relative">
                ...
                <!-- Repeat for other team members as necessary -->
            </div>
        </div>
    </div>
    <!-- Team End -->
